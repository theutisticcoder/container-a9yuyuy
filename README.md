...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-a9yuyuy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-a9yuyuy.containers.anotherwebservice.com/
...
```
git clone git@github.com:theutisticcoder/container-a9yuyuy.git
cd container-a9yuyuy
```
...
```
docker attach container-a9yuyuy
```
